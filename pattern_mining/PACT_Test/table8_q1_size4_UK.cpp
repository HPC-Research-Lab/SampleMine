...
//    printf("2222\n");
  ...
  auto H2 = build_tables(sgls2);
    ...
    Sampler *sm_tmp = new ProportionalSampler2({ 1024, 1024 });
    //ProportionalSampler2({ 8, 8 });
...
//    printf("44444\n");
  ...
  Sampler *sm2;
  if (st2 > 0)
    sm2 = new ProportionalSampler2({ st2/*=64*/, 1024 });
//    sm2 = new ProportionalSampler2({ st2/*=64*/, 1/*=8*/ });
