...
int main(int argc, char* argv[]) {
  ...
  auto [d3, ess3] = join<true, false, false, 2, 3, 3>(g, H2, sgls2, true, none, { 0, 0 }, subgraph_hist2, -1, true);
  ...
  util::Timer t;
  t.start();
  auto [d_res, ess] = join<true, false, false, 2, 4, 4>(g, H, sgls, false, sm2, { st2, st2 }, subgraph_hist, -1, false, st2 > 0);
  t.stop();
