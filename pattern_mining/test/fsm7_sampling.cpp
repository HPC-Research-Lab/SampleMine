...
/* Example: ./fsm7_sampling.exe /data/not_backed_up/shared/gpm_data/citeseer.lg 0.001 1 10
...
int main(int argc, char* argv[]) {
  ...
  for (int i = 0; i < sampling_rounds; i++) {
    ...
    util::Timer t;
    t.start();
    auto [d_res, ess] = join<true, true, true, false, 3, 4, 4, 4>(g, H, sgls, false, sm, { st, st, st}, sw, sup);
    t.stop();
